...
`);
        chai_1.assert.include(output, 'Made 2 changes to toplevel-bad.html');
        chai_1.assert.include(output, 'Made 2 changes to subdir/nested-bad.html');
        chai_1.assert.include(output, 'Fixed 2 warnings.');
    }));
...
`);
        chai_1.assert.include(output, 'Made 2 changes to toplevel-bad.html');
        chai_1.assert.include(output, 'Fixed 1 warning.');
    }));
    test('only applies safe fixes when not prompting', () => __awaiter(this, void 0, void 0, function* () {
        ...
        chai_1.assert.deepEqual(`  Made 4 changes to file.html
...
`);
    ...
    test('applies edit actions when requested by command line', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const output = yield result;
        chai_1.assert.deepEqual(`  Made 8 changes to file.html
...
`);
    ...
    suite('--watch', function () {
        ...
        test('re-reports lint results when the filesystem changes', () => __awaiter(this, void 0, void 0, function* () {
...
`);
        ...
        const testName = 'with --fix, reports and fixes when the filesystem changes';
        test(testName, () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.assert.deepEqual(yield reader.readUntil(delimiter), `  Made 2 changes to my-elem.html
